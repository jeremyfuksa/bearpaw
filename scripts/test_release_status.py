...
class SectionEntriesTest(unittest.TestCase):
    def test_reads_only_the_unreleased_section(self):
        ...
        self.assertEqual(
            release_status.section_entries(changelog, "1.1.1"),
            ["**A fix that has not shipped.** Detail.", "**A second one.**"],
        )

    def test_empty_unreleased_section_reports_nothing(self):
        changelog = "# Changelog\n\n## [1.1.1]\n\n## [1.1.0] - 2026-09-02\n\n- **Shipped.**\n"
        self.assertEqual(release_status.section_entries(changelog, "1.1.1"), [])

    def test_missing_unreleased_section_reports_nothing(self):
        self.assertEqual(release_status.section_entries("# Changelog\n\n## [1.1.0]\n", "1.1.1"), [])
    ...
    def test_unreleased_last_in_file_still_reads(self):
        ...
        changelog = "# Changelog\n\n## [1.1.1]\n\n- **Only entry.**\n"
        self.assertEqual(release_status.section_entries(changelog, "1.1.1"), ["**Only entry.**"])
