...
function Status() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Status">
      ...
      <p className="font-['Manrope:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#f5ebe8] text-[10px] text-nowrap">BC125AT</p>
    </div>
  );
}
...
function MainContent() {
  return (
    <div className="content-stretch flex items-center justify-between pb-[4px] pt-0 px-0 relative shrink-0 w-full" data-name="Main Content">
      ...
      <p className="font-['Manrope:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[24px] text-[rgba(28,31,39,0.9)] text-nowrap">ASH3D Flappy Fart</p>
      <Status1 />
    </div>
  );
}
...
function SecondaryContent() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full" data-name="Secondary Content">
      <p className="font-['Manrope:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[12px] text-[rgba(28,31,39,0.9)] text-nowrap">444.525 • NFM • CH67</p>
    </div>
  );
}
...
function Frequency() {
  return (
    <div className="h-[12px] relative shrink-0 w-[45px]" data-name="Frequency">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-0 not-italic text-[#f5ebe8] text-[12px] text-nowrap top-0">157.1000</p>
    </div>
  );
}
...
function Tag() {
  return (
    <div className="h-[12px] relative shrink-0 w-[69px]" data-name="Tag">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-0 not-italic text-[#f5ebe8] text-[12px] text-nowrap top-0">Marine CH22</p>
    </div>
  );
}
...
function Frequency1() {
  return (
    <div className="h-[12px] relative shrink-0 w-[45px]" data-name="Frequency">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-0 not-italic text-[#f5ebe8] text-[12px] text-nowrap top-0">160.2500</p>
    </div>
  );
}
...
function Tag1() {
  return (
    <div className="h-[12px] relative shrink-0 w-[69px]" data-name="Tag">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-0 not-italic text-[#f5ebe8] text-[12px] text-nowrap top-0">DX Enthusiast</p>
    </div>
  );
}
...
function Frequency2() {
  return (
    <div className="h-[12px] relative shrink-0 w-[45px]" data-name="Frequency">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-0 not-italic text-[#f5ebe8] text-[12px] text-nowrap top-0">146.5200</p>
    </div>
  );
}
...
function Tag2() {
  return (
    <div className="h-[12px] relative shrink-0 w-[69px]" data-name="Tag">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-0 not-italic text-[#f5ebe8] text-[12px] text-nowrap top-0">W0TE</p>
    </div>
  );
}
...
function Frequency3() {
  return (
    <div className="h-[12px] relative shrink-0 w-[45px]" data-name="Frequency">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-0 not-italic text-[#f5ebe8] text-[12px] text-nowrap top-0">145.8000</p>
    </div>
  );
}
...
function Tag3() {
  return (
    <div className="h-[12px] relative shrink-0 w-[69px]" data-name="Tag">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-0 not-italic text-[#f5ebe8] text-[12px] text-nowrap top-0">CB Super Bowl</p>
    </div>
  );
}
...
function Frequency4() {
  return (
    <div className="h-[12px] relative shrink-0 w-[45px]" data-name="Frequency">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-0 not-italic text-[#f5ebe8] text-[12px] text-nowrap top-0">144.3900</p>
    </div>
  );
}
...
function Tag4() {
  return (
    <div className="h-[12px] relative shrink-0 w-[69px]" data-name="Tag">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-0 not-italic text-[#f5ebe8] text-[12px] text-nowrap top-0">Weak Signal</p>
    </div>
  );
}
