import svgPaths from "./svg-4af8p5er03";
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="status">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="status">
          <path d={svgPaths.p26c64136} fill="var(--fill-0, #1C1F27)" fillOpacity="0.9" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function MainContent() {
  return (
    <div className="content-stretch flex items-center justify-between pb-[4px] pt-0 px-0 relative shrink-0 w-full" data-name="Main Content">
      ...
      <p className="font-['Manrope:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[24px] text-[rgba(28,31,39,0.9)] text-nowrap">USB Error</p>
      <Status1 />
    </div>
  );
}
